...
api = Emotion_API(
	device = torch.device('cuda:0'), # If GPU is available, change it to torch.device('cuda:0')
	...
	OpenFace_exe = '../OpenFaceGit/x64/Release/FeatureExtraction.exe', # if OpenFace is installed somewhere else, replace the path here
